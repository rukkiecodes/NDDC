...
export const useAppStore = defineStore("app", {
  state: () => ({
    ...
    featuredNews: [
      {
        ...
        texts: [
          `In a groundbreaking achievement for infrastructure development in the Niger Delta, the Niger Delta Development Commission (NDDC) has completed the construction of a 132KV transmission line and substation in Abia State. This monumental project aims to revolutionize power supply in the region, driving economic growth, industrial development, and improved living standards for residents.`,
          `The newly completed substation is equipped with cutting-edge technology and serves as a critical link in the power distribution network. Designed to stabilize electricity supply across Abia and its neighboring states, the project addresses years of inadequate and inconsistent power delivery that has hampered development in the region.`,
          `At the commissioning ceremony, NDDC Managing Director, Dr. Samuel Ogbuku, emphasized the importance of reliable power infrastructure in regional development. "Reliable electricity is not just about convenience; it is the foundation of economic growth, improved healthcare, better education, and overall social progress. This project represents our unwavering commitment to addressing the region's challenges and unlocking its vast potential," he stated. The substation and transmission line are expected to drastically reduce power outages, enhance industrial efficiency, and attract investments to the area. Small and medium-sized enterprises (SMEs), which form the backbone of the local economy, stand to benefit immensely from a more stable and efficient power supply.`,
          ...
          `In addition to boosting economic activities, the project is seen as a pivotal step in NDDC’s broader mission of fostering sustainable development in the Niger Delta. By prioritizing critical infrastructure projects like this, the commission reaffirms its commitment to creating a thriving and self-reliant region.`,
          `The 132KV transmission line and substation in Abia State mark a significant stride toward a brighter and more electrified future for the Niger Delta. As the lights come on, so does the promise of progress for millions of lives in the region.`,
        ],
      },
      {
        image: woman,
        title:
          "NDDC Program: Building Financial Independence for Women in the Niger Delta",
        texts: [
          ...
          `The program offers a range of training sessions, including skills acquisition in entrepreneurship, vocational training, and financial literacy. By equipping women with these skills, the NDDC aims to enable them to start and manage their own businesses effectively, thereby creating sustainable income streams and reducing dependency.`,
          `Speaking at the program's launch, NDDC Director of Women Affairs, Mrs. Ebiere Tekena, emphasized the importance of empowering women for the region's overall development. "When women are empowered, families thrive, communities prosper, and the entire region benefits. This program reflects our commitment to fostering an inclusive economy that leaves no one behind," she said.`,
          `The initiative has already seen the participation of hundreds of women across various states in the Niger Delta, with success stories emerging of women starting small businesses in agriculture, trade, and technology. The program also includes mentorship sessions where successful female entrepreneurs share their journeys, challenges, and strategies for success.`,
          ...
          `This program is a testament to the NDDC's vision of a more inclusive and economically robust Niger Delta, where every individual, regardless of gender, has the opportunity to thrive.`,
        ],
      },
      {
        image: men,
        title:
          "Empowering the Future: NDDC Launches Youth Skill Acquisition Program in the Niger Delta",
        texts: [
          `The Niger Delta Development Commission (NDDC) has unveiled a comprehensive Youth Skill Acquisition Program designed to equip young men and women in the region with practical skills and resources to thrive in today’s competitive job market. This initiative underscores NDDC’s commitment to tackling youth unemployment and fostering sustainable development in the Niger Delta.`,
          `The program offers training in various fields, including technology, agriculture, craftsmanship, and digital marketing. By focusing on these areas, the NDDC aims to create a skilled workforce capable of driving innovation and entrepreneurship in the region.`,
          `At the launch event, NDDC Executive Director of Projects, Engr. Charles Ogunedo, highlighted the program’s significance. "The youth are the backbone of our nation. By investing in their skills and potential, we are not just securing their future but also the future of the Niger Delta," he stated.`,
          `Participants will also benefit from mentorship opportunities, startup capital for business ventures, and access to a network of industry professionals. The program prioritizes practical, hands-on training to ensure that participants are well-equipped to transition seamlessly into the workforce.`,
          `A beneficiary of the program, John Etuk from Rivers State, shared his excitement. "This is a golden opportunity for me to learn skills that can transform my life. I am grateful to the NDDC for this life-changing initiative," he said.`,
          `The Youth Skill Acquisition Program aligns with NDDC’s broader mission to address systemic challenges in the Niger Delta, including unemployment and poverty. By empowering the youth, the commission is laying the groundwork for a prosperous and self-reliant region.`,
    ...
    topThree: [
      {
        image: ttrtr,
        title: "Revolutionizing Road Infrastructure in the Niger Delta",
        texts: [
      ...
      },
      {
        ...
        texts: [
          `The Niger Delta is undergoing a major transformation with the construction of critical road infrastructure, spearheaded by the Niger Delta Development Commission (NDDC). These projects are set to revolutionize the region’s transportation system, making it easier for people and businesses to connect with one another and fostering economic growth.`,
          `One of the key focuses of the NDDC is to build roads that connect rural communities with urban centers, ensuring that development reaches all corners of the region. The improved road networks will enable farmers to bring their products to market faster, businesses to expand, and individuals to access essential services more easily.`,
          `Speaking at the launch of a new road project, Dr. Samuel Ogbuku, NDDC Managing Director, emphasized the importance of road infrastructure in driving the region's economic growth. "These roads are not just about travel; they are the arteries of the economy, facilitating trade, industry, and job creation," he explained.`,
          `Local communities have voiced their appreciation for the initiative. "The new roads will make it easier for us to get to work, attend school, and even visit relatives in neighboring towns," said Emeka Nwokolo, a young professional in Warri. "This is exactly what we need for a better future."`,
    ...
    forWomen: [
      {
        ...
        texts: [
          `In a bid to foster gender equality and economic independence, the Niger Delta Development Commission (NDDC) has launched several programs aimed at empowering women through skills training. These initiatives are designed to equip women across the region with the tools they need to succeed in the workforce and start their own businesses.`,
          `The programs, which span a wide range of sectors including agriculture, technology, and entrepreneurship, provide women with practical skills that can be directly applied to their careers. The NDDC is committed to breaking the barriers that have historically limited women's economic opportunities in the region.`,
          ...
          `One of the program participants, Adaora Nwokolo, shared her excitement about the skills she is acquiring. "I'm learning how to start my own business, and I feel more confident about my future now," she said. "The training is giving me the independence I need to support my family."`,
      ...
      },
      {
        ...
        texts: [
          `The Niger Delta Development Commission (NDDC) is taking bold steps to promote financial independence among women in the region. Through targeted educational programs and financial literacy workshops, the NDDC is helping women unlock their potential and take control of their finances.`,
          `Financial independence is a key goal for many women across the Niger Delta, and the NDDC’s programs are helping them achieve it. The initiatives focus on teaching women how to manage their finances, invest wisely, and start and grow their own businesses.`,
          `Dr. Samuel Ogbuku, NDDC Managing Director, highlighted the importance of these programs in his speech at a recent financial literacy workshop. "Empowering women financially means creating a more sustainable future for the Niger Delta. When women have control over their financial resources, they can invest in their families, communities, and businesses," he remarked.`,
          ...
          `These programs not only aim to provide women with financial independence but also foster a sense of empowerment, as women are encouraged to contribute to the region’s economic development through their newfound knowledge and skills.`,
        ],
      },
      {
        image: bfi,
        ...
        texts: [
          `The Niger Delta Development Commission (NDDC) is working tirelessly to promote women’s economic empowerment through vocational training programs across the region. These programs are designed to provide women with the necessary skills to thrive in a variety of trades and professions, from fashion design to carpentry, catering, and more.`,
          ...
          `Dr. Samuel Ogbuku, NDDC Managing Director, emphasized the long-term benefits of the vocational training programs. "Vocational skills are a pathway to self-sufficiency, and when women are empowered with these skills, they become key players in the economic development of the Niger Delta," he said.`,
          `Many women have already benefited from these programs. "I’ve learned how to bake and run a business, and now I’m able to support my children,” said Mary Akpan, a graduate of the NDDC vocational training program. “This training has opened up new opportunities for me, and I’m proud to be able to provide for my family.”`,
    ...
    education: [
      ...
      },
      {
        ...
        texts: [
          `The Niger Delta Development Commission (NDDC) has placed a strong emphasis on vocational education as a key strategy for empowering the region’s youth. Recognizing that not all young people have the opportunity to pursue traditional academic paths, the NDDC is offering a range of vocational training programs to help youth develop the skills they need to secure stable, well-paying jobs.`,
          `These programs cover a wide range of trades, including carpentry, plumbing, electrical work, and technology. By providing hands-on training in these fields, the NDDC is ensuring that young people in the region are equipped with practical skills that are highly sought after in today’s job market.`,
